...
*Defined in [src/api/entities/TickerReservation/index.ts:50](https://github.com/PolymathNetwork/polymesh-sdk/blob/cfab557b/src/api/entities/TickerReservation/index.ts#L50)*
...
*Defined in [src/api/entities/TickerReservation/index.ts:190](https://github.com/PolymathNetwork/polymesh-sdk/blob/cfab557b/src/api/entities/TickerReservation/index.ts#L190)*
...
*Defined in [src/api/entities/TickerReservation/index.ts:86](https://github.com/PolymathNetwork/polymesh-sdk/blob/cfab557b/src/api/entities/TickerReservation/index.ts#L86)*
...
*Defined in [src/api/entities/TickerReservation/index.ts:87](https://github.com/PolymathNetwork/polymesh-sdk/blob/cfab557b/src/api/entities/TickerReservation/index.ts#L87)*
...
*Defined in [src/api/entities/TickerReservation/index.ts:215](https://github.com/PolymathNetwork/polymesh-sdk/blob/cfab557b/src/api/entities/TickerReservation/index.ts#L215)*
...
*Defined in [src/api/entities/TickerReservation/index.ts:177](https://github.com/PolymathNetwork/polymesh-sdk/blob/cfab557b/src/api/entities/TickerReservation/index.ts#L177)*
...
**`note`** this method is of type [NoArgsProcedureMethod](../interfaces/noargsproceduremethod.md), which means you can call `extend.checkAuthorization`
  on it to see whether the Current Account has the required permissions to run it
...
*Defined in [src/api/entities/TickerReservation/index.ts:228](https://github.com/PolymathNetwork/polymesh-sdk/blob/cfab557b/src/api/entities/TickerReservation/index.ts#L228)*
...
*Defined in [src/api/entities/TickerReservation/index.ts:208](https://github.com/PolymathNetwork/polymesh-sdk/blob/cfab557b/src/api/entities/TickerReservation/index.ts#L208)*
